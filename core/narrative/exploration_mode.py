...
# 整理/盤點/暫停調查 → review_mode
# 注意：「不碰真相 / 不追真相」**不**放這裡——那是 per-beat 的 no_truth 訊號（只擋本 beat reveal），
# 不該把整個探索鎖進 review（玩家可以一邊找路一邊「不碰真相」）。review 鎖須要明確的整理/撤退意圖。
_REVIEW = ["整理線索", "整理筆記", "盤點線索", "回顧線索", "梳理線索", "整理一下線索",
           "根據已知", "不新增調查", "暫停調查", "整理思緒", "重新理一遍"]
